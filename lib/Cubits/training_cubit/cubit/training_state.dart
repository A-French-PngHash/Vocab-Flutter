...
class TrainingState with _$TrainingState {
  ...
  factory TrainingState.word(String wordToTranslate, String? comment, int wordNumber, String textUnderField, Color textFieldColor) = _Word;
  ...
  factory TrainingState.correction(String wordToTranslate, bool correct, String correctTranslation, String translationInputed, int wordNumber,
      String? comment, String? grammarRule, String textUnderField, Color textFieldColor) = _Correct;
